...
public class PlayerManager {
    ...
    public Jukebox getJukebox(@NotNull Guild guild) {
        return this.guilds.computeIfAbsent(guild.getIdLong(), (id) -> {
            final Jukebox jukebox = new Jukebox(this.audioManager);
            guild.getAudioManager().setSendingHandler(jukebox.sendHandler);

            return jukebox;
        });
    }

    public void loadTrack(@NotNull TextChannel channel, String url) {
